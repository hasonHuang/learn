...
insert into users(username, password, password_salt) values('hason', '123', null);
insert into user_roles(username, role_name) values('hason', 'role1');
insert into user_roles(username, role_name) values('hason', 'role2');
