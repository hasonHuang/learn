...
insert into users(username, password, password_salt) values('com.hason', '123', null);
insert into user_roles(username, role_name) values('com.hason', 'role1');
insert into user_roles(username, role_name) values('com.hason', 'role2');
