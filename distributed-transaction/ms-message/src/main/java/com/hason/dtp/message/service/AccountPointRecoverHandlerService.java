 ...
 */
@Service
public class AccountPointRecoverHandlerService implements RecoverHandlerService {

    private static final Logger LOGGER = LoggerFactory.getLogger(AccountPointRecoverHandlerService.class);
